...
const [isImageAnalyzing, setIsImageAnalyzing] = useState(false);
  ...
  try {
    ...
    const response = await fetch('https://geowatch-backend-cmrc.onrender.com/analyze-location', {
      method: 'POST',
      headers: {
...
const handleImageClassification = async () => {
  ...
  try {
    ...
    const response = await fetch('http://geowatch-backend-cmrc.onrender.com/classify-image', {
      method: 'POST',
      body: formData,
    });
  ...
  try {
    const response = await fetch('http://geowatch-backend-cmrc.onrender.com/create-case', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
